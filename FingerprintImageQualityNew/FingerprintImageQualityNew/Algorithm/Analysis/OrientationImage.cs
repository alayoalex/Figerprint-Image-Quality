...
namespace FingerprintImageQualityNew.Algorithm.Analysis
{
    ...
    public class OrientationImage
    {
        ...
        public OrientationImage(byte width, byte height, double[,] orientations, byte wSize)
        {
            Width = width;
            Height = height;
            //TODO: para huellas de menos dimenciones, que los bloques sean de 8x8 y no de 16x16.
            WindowSize = wSize;
        ...
        public OrientationImage(byte width, byte height, byte wSize)
        {
            ...
            //TODO: para huellas de menos dimenciones, que los bloques sean de 8x8 y no de 16x16.
            WindowSize = wSize;
            orientations = new double[height, width];
        }
        ...
        private readonly double[,] orientations;
